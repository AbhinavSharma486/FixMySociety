      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-2">
            Why Choose <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Fix My Society</span>
          </h2>
          <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Streamline your society management with our comprehensive platform designed for modern communities.
          </p>
        </motion.div>
        ...
        <div className="md:hidden flex flex-col items-center">
          <div className="relative w-full max-w-sm mx-auto h-[250px] flex items-center justify-center">
            <AnimatePresence initial={false} custom={direction}>
              ...
              >
                {/* Inside Mobile/Tablet Card Navigation */}
                <div className={`w-14 h-14 bg-gradient-to-br ${features[currentIndex].color} rounded-2xl flex items-center justify-center mb-4`}>
                  {React.createElement(features[currentIndex].icon, { className: "w-7 h-7 text-white" })}
                </div>
