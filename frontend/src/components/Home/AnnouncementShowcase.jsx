...
const AnnouncementShowcase = ({ visibleElements }) => {
  ...
  // Memoize class name computations - only recompute when visibleElements changes
  ...
  return (
    <section className="relative py-32 overflow-hidden">
      {/* Animated background with gradient mesh - GPU accelerated */}
      <div className="absolute inset-0 bg-gradient-to-br from-slate-950 via-blue-950 to-purple-950">
        ...
        {/* Grid overlay - optimized with transform for GPU */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative inline-block group">
              ...
              <button
                ...
                className="relative flex items-center space-x-3 px-8 py-5 bg-gradient-to-r from-blue-600 via-blue-700 to-purple-700 rounded-2xl border border-blue-400/50 hover:scale-105 transition-all duration-300 shadow-2xl"
              >
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-900/40 backdrop-blur-2xl rounded-3xl border border-blue-400/20 shadow-2xl p-8 group-hover:scale-[1.02] transition-all duration-500">
                {/* Holographic overlay */}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          ...
                          className="relative flex items-start space-x-4 p-5 bg-slate-800/30 backdrop-blur-xl rounded-2xl border border-slate-700/50 hover:border-blue-400/50 hover:translate-x-2 transition-all duration-300 cursor-pointer"
                        >
                          {/* Status indicator with ripple effect */}
                          <div className="relative mt-2">
                            <div className={`w-3 h-3 rounded-full ${styles.bg} shadow-lg ${styles.shadow}`}></div>
                            <div className={`absolute inset-0 w-3 h-3 rounded-full ${styles.bg} animate-ping opacity-75`}></div>
                          </div>
