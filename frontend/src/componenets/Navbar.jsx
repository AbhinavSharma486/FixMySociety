    ...
    <div className="navbar bg-base-100 shadow-2xl border-b border-base-300 fixed w-full top-0 z-40 backdrop-blur-lg px-4 sm:px-6 md:px-8 lg:px-12 py-2">
      ...
      <div className="flex items-center gap-1 sm:gap-2 md:gap-3 lg:gap-4">
        ...
        <label className="swap swap-rotate mx-1 sm:mx-2">
          ...
          <svg className="swap-on h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 fill-current" viewBox="0 0 24 24">
          ...
          <svg className="swap-off h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 fill-current" viewBox="0 0 24 24">
            <path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z" />
          </svg>
        </label>

        {/* If the user is logged in, show bell icon and profile */}
        {currentUser && (
          <>
            {/* Notification Bell */}
