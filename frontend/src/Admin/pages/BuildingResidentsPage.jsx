...
const BuildingResidentsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 relative overflow-hidden p-3 sm:p-4 md:p-8 pt-20 sm:pt-24 md:pt-32">
