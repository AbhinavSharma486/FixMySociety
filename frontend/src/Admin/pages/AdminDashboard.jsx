...
import { Home, Building2, AlertTriangle, BarChart3, Users, MessageSquare, LoaderCircle, Radio, DoorOpen, Eye, Edit, Trash2 } from 'lucide-react';
...
// Memoized BuildingTableRow to prevent re-rendering of unchanged rows
...
const AdminDashboard = () => {
  ...
  // Memoize source buildings calculation
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            >
              <div className="absolute inset-0 opacity-20">
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-500 rounded-full blur-3xl animate-pulse" style={{ willChange: 'opacity' }} />
